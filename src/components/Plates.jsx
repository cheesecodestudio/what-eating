      ...
      <table className='w-full text-sm text-left rtl:text-right text-gray-500'>
        ...
        <tbody>
          <tr className="bg-white border-b ">
            ...
            <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
              <span className="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded">Chicken</span>
              <span className="bg-pink-100 text-pink-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded">Cornflour</span>
            </th>
            <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
        ...
        <form action="" className='mt-5'>
          <div className="grid gap-6 mb-6 md:grid-cols-3">
            ...
            <div className='flex items-center'>
              ...
              <label htmlFor="exist-checkbox" className="ms-2 text-sm font-medium text-gray-900">Exist</label>
            </div>
